        ...
        contents=[{
            ...
            "parts": [{
                "text": f"Create a {take_style()} frontend for this backend with theme {take_theme()} (invent fake data if necessary), retrieve all the necessary html, js and css"
                        ...
                        f" or template/name, this last one is important, ignore the healthcheck and if a file misses. Do not use any code enpointson the HTML to access the CSS or"
                        f" JS. {text}"
            }]
        }]
    ).text
