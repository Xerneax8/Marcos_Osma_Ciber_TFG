...
where the docker is described. This files should be just under the root of the challenge. To check if the challenge is healthy, it should have a healthcheck inside the "docker-compose.yml"
